...
public class ListaVendas extends javax.swing.JFrame {
     ...
     */
    public ListaVendas(Listas sistema) {
        super("Lista de todas as vendas");
        initComponents();
    ...
    public void carregarJtable(){
        ...
        for(Venda venda: sistema.getLvend()){
            modelo.addRow(new Object[]{venda.getIdProd(),venda.getNomedoProd(),venda.getQuantidade(),venda.getMontante()});
        }
