...
public class Recibo extends javax.swing.JFrame {
     ...
     */
    public Recibo(Listas sistema,Venda x) {
        super("Recibo");
        initComponents();
        this.sistema = sistema ;
        this.nomedoproduto = x.getNomedoProd();
        this.qunatidade = x.getQuantidade();
        this.pagamento = x.getMontante();
        jTextField2.setText(nomedoproduto);
        jTextField4.setText(String.valueOf(qunatidade));
        jTextField1.setText(String.valueOf(pagamento));
    }
