...
public class OrderList extends javax.swing.JFrame {
    ...
    public void loadTable() {
        ...
        for (Order order : system.getOrderList()) {
            model.addRow(new Object[]{order.getNumber(), order.getName(), order.getIdProd(), order.getProductName(), order.getQuant(), order.getInformation(), order.getAmount()});
        }
